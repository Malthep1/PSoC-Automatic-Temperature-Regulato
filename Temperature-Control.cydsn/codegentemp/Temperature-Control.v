...
module top ;
    ...
    PWM_v3_30_0 PWM_Power (
        ...
        .ph1(Net_153),
        .ph2(Net_154));
    defparam PWM_Power.Resolution = 8;
	...
	cy_psoc3_pins_v1_10
		#(.id("5a3ef3ab-448d-4394-b8e9-731c1d675825"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9c0a82f5-a274-49d6-87a8-e9e6bd1403be"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
